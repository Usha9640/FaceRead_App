...
👉 https://huggingface.co/spaces/Usha9640/Faceread
...
2. **Real-time Webcam Streaming:** Securely access webcam via browser, analyzing emotions locally at ~2.5 FPS using the Python backend.
